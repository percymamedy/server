...
class Type_collection_inet: public Type_collection
{
                                       ...
                                       const Type_handler *b) const
  {
    if (a == b)
      return a;
    DBUG_ASSERT(dynamic_cast<const Type_handler_inet6*>(a));
    DBUG_ASSERT(dynamic_cast<const Type_handler_inet6*>(b));
    return &type_handler_inet6;
  }
public:
